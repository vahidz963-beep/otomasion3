...
import { formatJalaliDate, formatToman, gregorianToJalali, toEnglishDigits, toPersianDigits } from '../../lib/formatters';
      ...
      {modal && (() => {
        ...
        return (
          <FinanceModal title={modalTitle(modalType)} onClose={() => setModal(null)}>
            ...
            {modalType === 'payment' && <FinancePaymentForm parties={data.parties} documents={activeDocuments} accounts={data.bankAccounts} categories={data.incomeExpenseCategories || []} initialDocumentId={modalDocumentId} initialPayment={typeof modal === 'object' ? modal.payment : null} busy={busy} onCancel={() => setModal(null)} onSubmit={submitPayment} />}
            {modalType === 'incomeExpense' && <FinancePaymentForm parties={data.parties} documents={[]} accounts={data.bankAccounts} categories={data.incomeExpenseCategories || []} initialDirection={(typeof modal === 'object' && modal.direction) || 'payment'} initialPayment={typeof modal === 'object' ? modal.payment : null} categoryMode busy={busy} onCancel={() => setModal(null)} onSubmit={submitPayment} />}
